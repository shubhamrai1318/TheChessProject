...
export const piecesDetermine = {
    ...
    get determinations() {//Generate new determinations
        //alert("Caling determinations")
    ...
    hasPiecePotential( pieceBoxPosition, determinationPosition ) {
        //pieceboxposition is src and determinationposition is des
        //alert(pieceBoxPosition + "," + determinationPosition)
        //alert(this._determinations)
        // console.log(this._determinations)
